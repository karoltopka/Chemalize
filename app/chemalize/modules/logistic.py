"""
Logistic Regression module - REFACTORED to use database instead of global variables.
"""
import numpy as np
import pandas as pd
...
def logisticReg(value, choice, scale_val, encode_val):
    ...
    if choice == 1:
        ...
        clf = LogisticRegression(
            random_state=0, solver="lbfgs", multi_class="auto", max_iter=150
        ).fit(X_train, y_train)
        ...
        # Save to database
        with AnalysisSession('logistic_regression', parameters=parameters) as db_session:
