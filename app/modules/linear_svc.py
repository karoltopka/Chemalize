"""
Linear SVC module - REFACTORED to use database instead of global variables.
"""
import numpy as np
import pandas as pd
...
def lin_svc(value, choice, scale_val, encode_val):
    """
    ...
    if choice == 1:
        ...
        # Save to database
        with AnalysisSession('linear_svc', parameters=parameters) as db_session:
