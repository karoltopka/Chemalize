"""
Random Forest module - REFACTORED to use database instead of global variables.
"""
import numpy as np
import pandas as pd
...
def RandomForest(value, choice, scale_val, encode_val):
    """
    ...
    if choice == 1:
        ...
        # Save to database
        with AnalysisSession('random_forest', parameters=parameters) as db_session:
    ...
    # Choice 0: External Test Set
        ...
        rfc = RandomForestClassifier(n_estimators=200).fit(X, y)
