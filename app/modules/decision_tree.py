"""
Decision Tree module - REFACTORED to use database instead of global variables.
"""
import numpy as np
import pandas as pd
import matplotlib
...
from app.preprocessing import generic_preprocessing as gprep
...
def DecisionTree(value, choice, scale_val, encode_val):
    ...
    """
    # Read data
    df = gprep.read_dataset(get_clean_path("clean.csv"))
    ...
    if choice == 1:
        ...
        # Save to database
        with AnalysisSession('decision_tree', parameters=parameters) as db_session:
            ...
            db_session.add_plot('decision_tree', 'tree.png', tree_plot_path)
    ...
    # Choice 2: K-Fold Cross Validation
        ...
        # Plot Decision Tree (using last trained model - not ideal but matches original)
